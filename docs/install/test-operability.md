...
| **Test Email**                        | Sendet eine Testnachricht an die in `aktin.properties` konfigurierte E-Mail-Adresse                                           |
| **Test R**                            | Überprüft die Funktionalität der R-Bibliotheken, die zur Erstellung von Berichten benötigt werden                             |
| **Monatsbericht erzeugen und senden** | Erstellt den AKTIN-Monatsbericht für den aktuellen Monat auf Basis der in der Datenbank gespeicherten Daten und versendet ihn |
